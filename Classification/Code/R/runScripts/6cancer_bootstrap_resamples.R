...
classes_levels =c("brca", "coad", "kidn", "lgg",  "lihc", "lung")# c("lihc","brca","lgg","coad",'kidn','lung')
...
cat("Dataset: 6cancer \n")
mat = readMat("/boston_ailab/users/rli/quantum/Data/6cancer_bootstrap_resamples.mat")
...
saveRDS(save_vars,paste("6cancer_bootstrap_resamples_save_", st_idx, ".RDS",sep=""))
