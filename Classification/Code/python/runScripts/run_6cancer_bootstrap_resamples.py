...
import pickle,gzip, numpy as np, scipy.io as sio, os, sys
...
# load embedding
embedding = pickle.load(gzip.open('/home/richard/Dropbox-Work/Wuxi/Embeddings/NASA_EmbedK65.pkl.gz'))
dataset = '6cancer'
...
for cinit in cinits :
    ...
    for n in range(100):
        tdata = traindatas[n]
        out = DW_utils.runMultiCV(tdata,[0],embedding,solver_name = 'NASA',num_reads=1000,num_gauges=10,coupling_init=cinit,stop_point=-0.01,method='vote')
        outlist_new[n] = out
