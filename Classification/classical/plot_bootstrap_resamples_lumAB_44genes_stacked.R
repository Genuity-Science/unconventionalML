...
l = readRDS("lumAB_multicut_multirun/2019_04_09_LUMAB_ALL_MULTICUT/lumab_multicut_multirun_44genes_save.RDS")
l.info <- l$info
...
# Field info
all_fl_info = readRDS(paste(base_dir,"latest.files.from.richard/","lumAB_gene_bootstrap_resamples_field.RDS",sep=""))
...
all_info = rbind(all_dw_info,l.info,all_sa_info,all_rand_info,all_fl_info) #all_ibm_info,
...
algo_df$method = factor(algo_df$method,levels=c("SVM","LASSO","Ridge","RF","NB" ,"SA","DWave","Random","Field")) #"IBMsim"
