function [r,t] = analyze_multinomial_bootstrap_resamples_simple(out,saveFlag,cinits);
...
%        sols = cellfun(@(x) x(1:5,:),sols,'uniformoutput',false);
    ...
    if saveFlag
        try
            ...
            save(['~/Dropbox-Work/Wuxi/Results/bootstrap_resamples/6cancer_bootstrap_resamples/results.mat'],rname,tname)
        end
    end
end
